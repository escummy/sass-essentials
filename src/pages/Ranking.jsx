...
export const Ranking = () => {
  ...
  const TOP_RATED = BASE_URL + "movie/top_rated";
  ...
  // Async function to show available movies
  const fetchMovies = async (event) => {
    if (event) {
      event.preventDefault();
    }

    const { data } = await axios.get(`${searchKey ? SEARCH : TOP_RATED}`, {
      params: {
        api_key: API_KEY,
        query: searchKey,
      },
  ...
  // Async function to render the movie poster
